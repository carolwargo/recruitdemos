...
{#main {margin-left: 0}}
      ...
      <div className="page-container ">
        ...
        <InView triggerOnce={true}>
          {({ inView, ref }) => (
            <div
              ref={ref}
              className={`w3-content w3-justify w3-text-light-grey w3-padding-16 
            ${inView ? "animate-fade-in" : ""}`}
              id="downloads"
            >
                  <hr className="w3-opacity w3-text-white w3-padding-16 w3-margin-top" /> 
          <h1 className="w3-text-light-grey w3-margin-bottom" style={{textShadow:'1px 1px 2px black'}}>Downloads Dashboard</h1>
          <p></p>
    <div className="row justify-content-center d-flex shadow rounded bg-dark " style={{ border: "2px solid #545454" }}>
 <div className="col-sm-12 col-md-4 col-lg-4 bg-dark  pt-2 px-0" style={{ borderRight: "2px solid #545454" }}>
      <div className="rounded container my-2 w3-padding-large">
        ...
        <p className="small opacity-65">Select a document to view. PDF versions with clickable links are an option.</p>
        </div>
...
{/**  References (Letters)*/}
 ...
 {/** Resume*/}
    ...
    <p><span className="py-1  small"><i className=" fas fa-star" style={{marginRight:'2px'}}></i> </span> <Link 
    to="/" 
    className="link-light small opacity-65 alert-style"
  >
